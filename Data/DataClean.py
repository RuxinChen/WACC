...
"Monteal", "Henderson", "Tempe", "Chandler", "Edinburgh"\
...
class MRDataClean(MRJob):
    ...
    def mapper(self, _, line):
        ...
        try:
            line = RestaurantsTakeOut, GoodForKids, business_id, name,\
            RestaurantsReservations, Ambience.casual,\
            state, hours.Tuesday, hours.Thursday, GoodForDancing,\
            BYOB, Music.live, BusinessAcceptsCreditCards,\
            RestaurantsGoodForGroups, is_open, categories,\
            Ambience.trendy,DietaryRestrictions.vegan,\
            longitude, neighborhood, DietaryRestrictions.vegetarian,\
            address, OutdoorSeating, GoodForMeal.brunch,\
            GoodForMeal.latenight, ByAppointmentOnly,\
            RestaurantsDelivery, GoodForMeal.dessert,\
            review_count, hours.Wednesday, Ambience.romantic,\
            RestaurantsCounterService, Music.dj,\
            Ambience.upscale, latitude, hours.Monday, Alcohol,\
            Ambience.classy, RestaurantsPriceRange2,\
            hours.Sunday, NoiseLevel, DietaryRestrictions.dairy-free,\
            hours.Friday, RestaurantsTableService, Music.background_music,\
            Open24Hours, city, DietaryRestrictions.gluten-free,\
            RestaurantsAttire, hours.Saturday, HappyHour,\
            GoodForMeal.dinner, GoodForMeal.lunch,\
            WheelchairAccessible, AgesAllowed,\
            stars, WiFi, postal_code, GoodForMeal.breakfast
        except:
